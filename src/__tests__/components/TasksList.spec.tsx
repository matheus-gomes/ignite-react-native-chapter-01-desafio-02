...
describe('MyTasksList', () => {
  ...
  it('should be able to render all tasks', () => {
    const { getByDisplayValue } = render(<TasksList tasks={tasks} editTask={mockedEditTask} removeTask={mockedRemoveTask} toggleTaskDone={mockedToggleTaskDone} />)
  ...
  it('should be able to handle "removeTask" event', () => {
    const { getByTestId } = render(<TasksList tasks={tasks} editTask={mockedEditTask} removeTask={mockedRemoveTask} toggleTaskDone={mockedToggleTaskDone} />)
